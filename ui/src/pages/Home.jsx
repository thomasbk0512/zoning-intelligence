  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="mt-12 sm:mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card>
          <h2 className="text-lg sm:text-xl font-semibold mb-2 text-text">Search by APN</h2>
        ...
        <Card>
          <h2 className="text-lg sm:text-xl font-semibold mb-2 text-text">Search by Location</h2>
          <p className="text-sm sm:text-base text-text-muted">
        ...
        <Card className="sm:col-span-2 lg:col-span-1">
          <h2 className="text-lg sm:text-xl font-semibold mb-2 text-text">Comprehensive Data</h2>
          <p className="text-sm sm:text-base text-text-muted">
